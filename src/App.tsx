...
const bodiesOfWater = [
  ...
  },
  {
    ...
    accent: 'text-emerald-400',
    stats: { location: 'Bethesda/Chevy Chase, MD', type: 'Urban Stream', trail: 'Capital Crescent' },
  ...
  },
  {
    ...
    accent: 'text-amber-500',
    stats: { location: 'Bethesda/Chevy Chase, MD', type: 'Rest Area', views: 'Streams & Trails' },
    coordinates: [38.9600, -77.1050] as [number, number]
  },
  {
    id: 'willett_branch',
    type: 'Branch',
